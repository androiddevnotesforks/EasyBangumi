...
fun ColumnScope.PlayerSetting(
    ...
    Column(
        ...
        BooleanPreferenceItem(
            title = { stringResource(id = com.heyanle.easy_i18n.R.string.use_external_player) },
            preference = settingPreferences.useExternalVideoPlayer
        )

        EmumPreferenceItem(
            title = { stringResource(id = com.heyanle.easy_i18n.R.string.player_orientation_mode) },
            textList = listOf(
